...
const timeline = [
    {
        Logo: Logo1,
        heading: "Lãnh đạo",
        Description: "Cam kết toàn diện cho sự thành công của công ty",
    },
    {
        Logo: Logo2,
        heading: "Trách nhiệm",
    ...
    },
    {
        Logo: Logo3,
        heading: "Linh hoạt",
        Description: "Khả năng thích ứng là một kỹ năng quan trọng",
    },
    {
        Logo: Logo4,
                ...
                <motion.div
                    ...
                    <div className=' absolute bg-caribbeangreen-700 flex flex-row text-white uppercase py-7
                        ...
                        <div className='flex flex-row gap-5 items-center border-r border-caribbeangreen-300 px-7'>
                            ...
                            <p className='text-caribbeangreen-300 text-xs lg:text-sm'>Năm kinh nghiệm
</p>
                        </div>

                        <div className='flex gap-5 items-center px-7'>
                            <p className='text-2xl lg:text-3xl font-bold'>250</p>
                            <p className='text-caribbeangreen-300 text-xs lg:text-sm'>Loại khóa học
</p>
                        </div>
